...
<section class="hero" id="hero">
	<div class="container">
		<h2 class="sub-headline sub-headline-hero">
			<span class="first-letter">L</span>'attaque
		</h2>
		...
		<div class="headline-description">
			...
			<div class="single-animation">
				<h5>Tu es plus a l'aise en defense ?</h5>
				<a href="/Find6Friends/operator_type/defenseur/" class="btn cta-btn">Cliques ici</a>
			</div>
		</div>
	</div>
</section>
			...
			<div class="story-info">
				...
				<div class="story-description animate-right">
					<div class="global-headline">
						...
						<h1 class="headline headline-dark">Assaillant</h1>
					</div>
